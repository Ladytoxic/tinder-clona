...
const btnLike = document.getElementsByClassName('is-like')[0];
const btnNope = document.getElementsByClassName('is-nope')[0];

const like = btnLike.addEventListener('click', () => {
    const articles = document.querySelectorAll('article');
    const actualCard = articles[articles.length - 1];
    actualCard.remove()
    console.log('click en like');

});

const nope = btnNope.addEventListener('click', () => {
    const articles = document.querySelectorAll('article');
    const actualCard = articles[articles.length - 1];
    actualCard.remove()
    console.log('click en nope');
});
